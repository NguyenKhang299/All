package com.photo.image.picture.tools.compressor.persentation.sup_vip
...
import com.photo.image.picture.tools.compressor.databinding.ActivitySubVipBinding
...
class SubVipActivity : BaseActivity<ActivitySubVipBinding>() {
    override fun provideViewBinding() = ActivitySubVipBinding.inflate(layoutInflater)
