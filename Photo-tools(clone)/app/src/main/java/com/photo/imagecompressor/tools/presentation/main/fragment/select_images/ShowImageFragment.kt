...
import com.photo.imagecompressor.tools.databinding.FragmentShowImageBinding
...
class ShowImageFragment : BaseFragment<FragmentShowImageBinding>() {
    ...
    override fun setupObservers() {
        mainImageViewModel.apply {
            ...
            imagesLiveData.observe(this@ShowImageFragment) {
                if (this@ShowImageFragment.isAdded) {
                    if (it.isEmpty()) {
            ...
            mainImageViewModel.closeSelectedLiveData.observe(this@ShowImageFragment) { it ->
                if (this@ShowImageFragment.isAdded) if (it) {
